...
NonBlockingAction AudioSequences::_uk_ring_actions[4] = { _uk_ring_on, _sound_off, _uk_ring_on, _sound_off};
...
NonBlockingAction AudioSequences::_busy_actions[2] = { _busy_on, _sound_off};
...
NonBlockingAction AudioSequences::_uk_busy_actions[2] = { _uk_busy_on, _sound_off};
...
NonBlockingAction AudioSequences::_reorder_actions[2] = { _busy_on, _sound_off};
...
NonBlockingAction AudioSequences::_uk_reorder_actions[4] = { _uk_busy_on, _sound_off, _uk_busy_on, _sound_off};
...
NonBlockingAction AudioSequences::_error_actions[4] = { _error_tone1_on, _error_tone2_on, _error_tone3_on, _sound_off};
...
NonBlockingAction AudioSequences::_uk_error_actions[1] = { _uk_busy_on };
...
NonBlockingAction AudioSequences::_cancel_actions[4] = { _cancel_tone_on, _sound_off, _cancel_tone_on, _sound_off};
